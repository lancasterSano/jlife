...
$smarty->assign('is_do', 1); $smarty->assign('block_page_sys', "paragraf");
...
// if($partparagraphs)
// {
//  	$notices['MW_TEACHER_HAS_NO_SUBGROUPS'] = array('type' =>2,
// 	            'messages' => array( 
// 	            )
// 	        );
...
$block_include_head = $smarty->fetch("./include_head/do/USMF/inc_paragraph.tpl"); $smarty->assign('block_include_head', $block_include_head);
...
$classParentMainField_tpl = $smarty->fetch("./mainContent/do/mainfield/paragraph.tpl"); $smarty->assign('block_mainField', $classParentMainField_tpl);
