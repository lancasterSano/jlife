$(document).ready(function(){
    testResultResponsible.assignPopupToTests();
});

var testResultResponsible = {
    ...
    onClickMark: function(obj, idsubject, ddate, idlearner, idschool){
        var paragraphs = testResultResponsible.loadParagraphs(idlearner, ddate, idsubject);
        ...
        if(paragraphs){
            if(!obj.cPopup('isInit')) {
                obj.cPopup('open', {
                    ...
                    body: testResultResponsible.prepareParagraphsUI(paragraphs,idschool)
                });
