 ...
 */
class DOSPResponsiblelearners extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('learnerS_id1, responsibleS_id1, schoolS_id', 'required'),
			array('relationS_id, learnerS_id1, responsibleS_id1, schoolS_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, relationS_id, learnerS_id1, responsibleS_id1, schoolS_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'learnerSId1' => array(self::BELONGS_TO, 'DOLearners', 'learnerS_id1'),
	 ...
	 * @return DOSPResponsiblelearners the static model class
	 */
