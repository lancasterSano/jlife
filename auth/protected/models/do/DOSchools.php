 ...
 * @property Schoolratio[] $schoolratios
 ...
 */
class DOSchools extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'schoolratios' => array(self::HAS_MANY, 'Schoolratio', 'idschool'),
			'spisokresponsiblelearners' => array(self::HAS_MANY, 'Spisokresponsiblelearners', 'schoolS_id'),
	 ...
	 * @return DOSchools the static model class
	 */
