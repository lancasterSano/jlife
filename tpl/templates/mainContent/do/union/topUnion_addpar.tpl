...
<div class="union">
  <div class="choose">
    ...
    <a id='idForCursor'  {if $numTab == 4} class="testActive" {else} class = "test"  {/if} href="addQuest.php?school={$school}&paragraph={$paragraph.id}">Конфигурация теста</a>
  </div>
  ...
  <div class="divide">
    ...
    <div class="defaultLine">
      <div class="divideName">
        ...
        <a  href='#s_newPart' class="addPar"><img src="../../img/add.png"> <span   onclick="addpar.addPartUI(); " style="float:right">Добавить новый раздел</span></a>
      </div>
    </div>  
  </div>
</div>
