...
if(isset($state) && isset ($idProfileAuth) && isset ($idProfileLoad) && isset ($idAlbum))
{
	if(!$state)
    {
        // ставим Like
        $p = $DB->query(QS::$insertLikeAlbum, $idProfileLoad, $idProfileLoad, $idAlbum, $idProfileAuth);
        $rez = array("insert", $p);
    }
    else
    {
        // убираем Like
        $p = $DB->query(QS::$deleteLikeAlbum, $idProfileLoad, $idProfileLoad, $idProfileLoad, $idAlbum, $idProfileLoad, $idProfileAuth);
        $rez = array("delete", $p);
    }
